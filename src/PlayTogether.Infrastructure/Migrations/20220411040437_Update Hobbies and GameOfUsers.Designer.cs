...
namespace PlayTogether.Infrastructure.Migrations
{
    ...
    [Migration("20220411040437_Update Hobbies and GameOfUsers")]
    partial class UpdateHobbiesandGameOfUsers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlayTogether.Infrastructure.Entities.BehaviorHistory", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("PlayTogether.Infrastructure.Entities.BehaviorPoint", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("PlayTogether.Infrastructure.Entities.BehaviorHistory", b =>
                {
                    b.HasOne("PlayTogether.Infrastructure.Entities.BehaviorPoint", "BehaviorPoint")
            ...
            modelBuilder.Entity("PlayTogether.Infrastructure.Entities.BehaviorPoint", b =>
                {
                    b.HasOne("PlayTogether.Infrastructure.Entities.AppUser", "User")
                        ...
                        .HasForeignKey("PlayTogether.Infrastructure.Entities.BehaviorPoint", "UserId");
