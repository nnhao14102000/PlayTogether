...
namespace PlayTogether.Infrastructure.Migrations
{
    ...
    [Migration("20220315004624_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlayTogether.Infrastructure.Entities.Deposit", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("PlayTogether.Infrastructure.Entities.UserWithdraw", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("PlayTogether.Infrastructure.Entities.Order", b =>
                {
                    b.HasOne("PlayTogether.Infrastructure.Entities.AppUser", null)
                        .WithMany("Orders")
