namespace PlayTogether.Core.Dtos.Incoming.Generic
{
    public class ErrorMessageConstants
    {
        ...
        public const string NotOwnInfo = "Thông tin không thuộc về sở hữu của bạn.";
        public const string Disable = "Tài khoản của bạn đang bị khóa. Vui lòng quay lại sau.";
        public const string DisableUser = "Tài khoản người dùng này đang bị khóa. Vui lòng quay lại sau.";
        public const string Offline = "Tài khoản của bạn đang Offline. Vui lòng đăng nhập lại.";
        ...
        public const string NotReadNoti = "Chưa đọc thông báo.";
    }
}